...
hl_getinvolved_ui = function(){
  story_section(
    ...
    content = list(      
      p(HTML("Simply create an iNaturalist account, upload a photo and/or audio recording of any species you find within a protected park, and include its location. Your observation will automatically be added to the <b><a href='https://inaturalist.ca/projects/bc-parks', target='_blank'>BC Parks iNaturalist Project</a></b>.")),
...
hl_thankyou_ui = function(){
  story_section(
    ...
    content = list(      
      ...
      p(HTML("Finally, a big thank you to <b>our dedicated field team</b>, who spend every summer tirelessly documenting as many species as they can. You can follow along with their uploads here: <a href='https://inaturalist.ca/projects/bc-big-summer-teams', target='_blank'>inaturalist.ca/projects/bc-big-summer-teams</a>"))
    ),
    position = "center",
    width = 600, 
    bg_color = "white"
