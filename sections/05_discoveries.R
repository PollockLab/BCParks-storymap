...
hl_discoveries1_ui = function(){
  ...
  "hl_discoveries1" = story_section(
    ...
    position = "right",
    content = list(
      p(HTML("This beautiful fungus (<i>Lachnum gaultheriae</i>) was discovered growing on Salal in the Hakai Luxvbalis Conservancy for the first time in Canada on iNaturalist by <a href='https://www.inaturalist.org/people/eloraa', target='_blank'>Elora Adamson</a>. Since then, four more observations have been made this summer, with likely many more to come!")),
...
hl_discoveries2_ui = function(){
  ...
  "hl_discoveries2" = story_section(
    ...
    content = list(
      p(HTML("This March Fly (<i>Bibiodes aestiva</i>) was documented for the first time on iNaturalist on Mount Kobau in the South Okanagan South Okanagan Grasslands Protected Area by our team. <a href = 'https://inaturalist.ca/people/abbyhyde', target='_blank'>Abby Hyde</a>, <a href ='https://inaturalist.ca/people/shawnb2', target='_blank'>Shawn Brescia</a>, and <a href ='https://inaturalist.ca/people/jbindernagel', target='_blank'>Jack Bindernagel</a> each found it separately. Interestingly, although these seemed to have been abundant in this location, these are the first records ever made of this species on iNaturalist. Photograph by <a href = 'https://inaturalist.ca/people/abbyhyde', target='_blank'>Abby Hyde</a>.")),
